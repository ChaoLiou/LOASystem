          ...
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12">
              ...
              <v-card-text>
                ...
                <v-alert outline v-model="status.failed" type="error">{{
                  status.message
                }}</v-alert>
                <v-chip label outline color="primary" v-if="config.dev">
                  <v-icon left>storage</v-icon>
                  {{
                    config.API_URL.replace("http://", "").replace(
                      "https://",
                      ""
                    )
                  }}
              ...
              <v-card-actions>
                <v-tooltip bottom>
                  <a
                    slot="activator"
                    href="https://qr-official.line.me/sid/L/319dfdjs.png"
                    target="_blank"
                  >
                    <v-img
                      contain
                      height="50"
                      width="50"
                      src="../static/LINE_APP.png"
                    ></v-img>
                  </a>
                  <span>快加入好友，立即掌握請假與簽核訊息</span>
                </v-tooltip>
                <v-spacer></v-spacer>
                <v-tooltip bottom>
                  <a
                    ...
                    href="http://10.110.1.200:3001/s/BJabRIhsm"
                    target="_blank"
                  >
                    <v-btn icon large>
                      <v-icon large>import_contacts</v-icon>
                    </v-btn>
                  </a>
                  <span>Infostrum 請假系統手冊</span>
                </v-tooltip>
                <v-btn
